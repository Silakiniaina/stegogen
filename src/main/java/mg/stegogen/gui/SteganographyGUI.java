...
public class SteganographyGUI extends JFrame {
    ...
    private void validateInputs() {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Invalid positions format. Use comma-separated numbers (e.g., 1,54,65,3)");
        }
    ...
    // In SteganographyGUI.java, modify the embedMessage method
    ...
    private void embedMessage(MediaType mediaType, String inputPath, String outputPath,
        ...
        // Calculate how many positions are needed - No longer adding END_MARKER length
        String binaryMessage = SteganographyUtils.isBinary(message) ? message
                : SteganographyUtils.textToBinary(message);
        int requiredPositions = binaryMessage.length();
